...
// (`$HOME/.termifier/state/history/<id>.raw`, see
// `termifier-session/crates/daemon/src/history.rs`'s `active_path`),
...
struct SessionHistoryFileReader {
    ...
    /// `$HOME/.termifier/state/history/<id>.raw`. Rotation to `<id>.raw.1`
    ...
    private func activePath(id: String) -> String {
        "\(homeDir)/.termifier/state/history/\(id).raw"
    }
