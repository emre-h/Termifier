...
final class GroupManagementUITests: TermifierUITestCase {
    ...
    func test_switchGroup() {
        ...
        // (WindowSession/TermifierWindowController.createNewGroup sets
    ...
    func test_collapseGroupHidesTabs() {
        ...
        let initialTabCount = countElements(matching: "termifier.sidebar.tab.")
        ...
        let tabCountAfterCollapse = countElements(matching: "termifier.sidebar.tab.")
        XCTAssertEqual(
    ...
    func test_expandGroupShowsTabs() {
        ...
        let tabCountCollapsed = countElements(matching: "termifier.sidebar.tab.")
        XCTAssertEqual(
            tabCountCollapsed, 0,
            "All tabs should be hidden after collapsing the group"
        )
        ...
        let tabCountExpanded = countElements(matching: "termifier.sidebar.tab.")
        XCTAssertGreaterThanOrEqual(
            tabCountExpanded, 1,
    ...
    func test_consecutiveGroupCloseButtons() {
        ...
        let initialGroupCount = countElements(matching: "termifier.sidebar.group.", excludingSuffix: "Button")
