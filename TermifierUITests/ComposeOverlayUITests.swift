...
final class ComposeOverlayUITests: TermifierUITestCase {

    private func composeTextView() -> XCUIElement {
        app.descendants(matching: .any)
            .matching(identifier: "termifier.compose.textView")
            .firstMatch
    }
    ...
    func test_placeholderHidesWhenTyping() {
        ...
        let placeholder = app.descendants(matching: .any)
            .matching(identifier: "termifier.compose.placeholder")
            .firstMatch
    ...
    func test_enterSendsAndClearsText() {
        ...
        // (TermifierWindowController.sendComposeText calls
        ...
        let outFile = "/tmp/termifier-e2e-compose-\(ProcessInfo.processInfo.processIdentifier).txt"
