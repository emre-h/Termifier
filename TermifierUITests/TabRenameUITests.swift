...
final class TabRenameUITests: TermifierUITestCase {
    ...
    func test_renameTabByDoubleClick() {
        ...
        let tabRow = app.descendants(matching: .any)
            .matching(NSPredicate(format: "identifier BEGINSWITH %@", "termifier.sidebar.tab."))
            .firstMatch
        XCTAssertTrue(
        ...
        let renameField = app.descendants(matching: .any)
            .matching(NSPredicate(format: "identifier BEGINSWITH %@", "termifier.sidebar.tabNameTextField."))
            .firstMatch
        XCTAssertTrue(
    ...
    func test_renameInactiveTab() {
        ...
        let sidebarTabs = app.descendants(matching: .any)
            .matching(NSPredicate(format: "identifier BEGINSWITH %@ AND NOT identifier CONTAINS %@", "termifier.sidebar.tab.", "closeButton"))
