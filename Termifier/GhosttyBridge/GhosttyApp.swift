...
private let logger = Logger(subsystem: "com.termifier.terminal", category: "GhosttyApp")
...
private func ghosttyReadClipboardCallback(
    ...
    MainActor.assumeIsolated {
        ...
        case GHOSTTY_CLIPBOARD_SELECTION:
            ...
            pasteboard = .init(name: .init("com.termifier.selection"))
        default:
            pasteboard = .general
        }
...
extension Notification.Name {
    static let ghosttyCloseSurface = Notification.Name("com.termifier.ghostty.closeSurface")
    static let ghosttyNewWindow = Notification.Name("com.termifier.ghostty.newWindow")
    static let ghosttyNewTab = Notification.Name("com.termifier.ghostty.newTab")
    static let ghosttyNewSplit = Notification.Name("com.termifier.ghostty.newSplit")
    static let ghosttyCloseTab = Notification.Name("com.termifier.ghostty.closeTab")
    static let ghosttyCloseWindow = Notification.Name("com.termifier.ghostty.closeWindow")
    static let ghosttySetTitle = Notification.Name("com.termifier.ghostty.setTitle")
    static let ghosttySetPwd = Notification.Name("com.termifier.ghostty.setPwd")
    static let ghosttyCellSizeChange = Notification.Name("com.termifier.ghostty.cellSizeChange")
    static let ghosttyInitialSize = Notification.Name("com.termifier.ghostty.initialSize")
    static let ghosttySizeLimit = Notification.Name("com.termifier.ghostty.sizeLimit")
    static let ghosttyConfigChange = Notification.Name("com.termifier.ghostty.configChange")
    static let ghosttyColorChange = Notification.Name("com.termifier.ghostty.colorChange")
    static let ghosttyToggleFullscreen = Notification.Name("com.termifier.ghostty.toggleFullscreen")
    static let ghosttyRendererHealth = Notification.Name("com.termifier.ghostty.rendererHealth")
    static let ghosttyRingBell = Notification.Name("com.termifier.ghostty.ringBell")
    static let ghosttyShowChildExited = Notification.Name("com.termifier.ghostty.showChildExited")
    static let ghosttyGotoSplit = Notification.Name("com.termifier.ghostty.gotoSplit")
    static let ghosttyResizeSplit = Notification.Name("com.termifier.ghostty.resizeSplit")
    static let ghosttyEqualizeSplits = Notification.Name("com.termifier.ghostty.equalizeSplits")
    static let ghosttyDesktopNotification = Notification.Name("com.termifier.ghostty.desktopNotification")
    static let ghosttyStartSearch = Notification.Name("com.termifier.ghostty.startSearch")
    static let ghosttyEndSearch = Notification.Name("com.termifier.ghostty.endSearch")
    static let ghosttySearchTotal = Notification.Name("com.termifier.ghostty.searchTotal")
    static let ghosttySearchSelected = Notification.Name("com.termifier.ghostty.searchSelected")
    static let ghosttyGotoTab = Notification.Name("com.termifier.ghostty.gotoTab")
    static let ghosttyConfirmClipboard = Notification.Name("com.termifier.ghostty.confirmClipboard")
    ...
    static let ghosttyProgressReport = Notification.Name("com.termifier.ghostty.progressReport")
    ...
    /// covering shells Termifier's own `/command-event` shell integration
    ...
    static let ghosttyCommandFinished = Notification.Name("com.termifier.ghostty.commandFinished")
    static let smoothScrollSettingChanged = Notification.Name("com.termifier.smoothScrollSettingChanged")
    ...
    // observed by `TermifierWindowController.registerNotificationObservers()`.
    ...
    static let ghosttySetTabTitle = Notification.Name("com.termifier.ghostty.setTabTitle")
    /// `GHOSTTY_ACTION_COPY_TITLE_TO_CLIPBOARD`. `object` is the
    /// triggering `SurfaceView`; no `userInfo`.
    static let ghosttyCopyTitleToClipboard = Notification.Name("com.termifier.ghostty.copyTitleToClipboard")
    /// `GHOSTTY_ACTION_TOGGLE_COMMAND_PALETTE`. `object` is the
    /// triggering `SurfaceView`; no `userInfo`.
    static let ghosttyToggleCommandPalette = Notification.Name("com.termifier.ghostty.toggleCommandPalette")
    ...
    static let ghosttyMoveTab = Notification.Name("com.termifier.ghostty.moveTab")
    /// `GHOSTTY_ACTION_TOGGLE_MAXIMIZE`. `object` is the triggering
    /// `SurfaceView`; no `userInfo`.
    static let ghosttyToggleMaximize = Notification.Name("com.termifier.ghostty.toggleMaximize")
    /// `GHOSTTY_ACTION_RESET_WINDOW_SIZE`. `object` is the triggering
    /// `SurfaceView`; no `userInfo`.
    static let ghosttyResetWindowSize = Notification.Name("com.termifier.ghostty.resetWindowSize")
    ...
    static let ghosttyPromptTitle = Notification.Name("com.termifier.ghostty.promptTitle")
    ...
    /// no-payload shape. See `TermifierWindowController.processToggleSplitZoom
    /// (surfaceView:)` and `Termifier/Models/SplitTree.swift`'s own
    /// "MARK: - Zoom" section for the full contract.
    static let ghosttyToggleSplitZoom = Notification.Name("com.termifier.ghostty.toggleSplitZoom")
}
