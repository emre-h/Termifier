...
private let logger = Logger(subsystem: "com.termifier.terminal", category: "GhosttySurface")
...
final class GhosttySurfaceController: Identifiable {
    ...
    init?(app: ghostty_app_t, baseConfig: ghostty_surface_config_s, view: SurfaceView) {
        ...
        // Inject TERMIFIER_SURFACE_ID so the termifier-agent-hook script (installed
        ...
        // with TERMIFIER_SURFACE_ID prepended.
        ...
        let envKeys = ["TERMIFIER_SURFACE_ID"] + existingEnvKeys
...
private extension Array where Element == String {
    ...
    /// project/target and isn't reusable from Termifier.
    ///
