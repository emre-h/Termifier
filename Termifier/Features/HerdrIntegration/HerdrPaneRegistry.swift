...
// different notification than this one. The .termifierSurfaceDestroyed
...
// call.
//
// Pruned via .termifierSurfaceDestroyed (AgentRegistry.swift's notification,
...
/// (socketPath, paneID) becomes newly bridged to a Termifier surface, an
