...
actor LSPSession {
    ...
    init(
        ...
        languageId: String,
        client: LSPClient,
        clientCapabilities: ClientCapabilities = ClientCapabilities.termifierDefault(),
    ...
    private func installServerRequestHandlers() async {
        ...
        // feature below (see `ClientCapabilities.termifierDefault()`), which
...
// MARK: - ClientCapabilities.termifierDefault

extension ClientCapabilities {
    /// Termifier default: declares support for the full surface that
    ...
    static func termifierDefault() -> ClientCapabilities {
