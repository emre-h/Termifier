...
//  refactoring/diagnostics, and Termifier-side orchestration (install +
//  session lifecycle):
//
...
//      lsp_workspace_apply_edit      -> Termifier-internal (no LSP request)
...
private let bridgeLogger = Logger(subsystem: "com.termifier", category: "lsp.bridge")
...
final class MCPLSPBridge {
    ...
    /// integrations (`TermifierMCPServer`) construct the bridge without an
    ...
    /// legacy `TermifierMCPServer` wiring before installer support
