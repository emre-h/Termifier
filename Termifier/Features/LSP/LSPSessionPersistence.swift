...
//  file under `~/Library/Application Support/Termifier/lsp/sessions.json` so the
...
actor LSPSessionPersistence {
    ...
    /// window/tab persistence under `Termifier/Features/Persistence/`.
    ...
    ///   `~/Library/Application Support/Termifier/lsp/sessions.json` (resolved
    ...
    private static func defaultStorageURL() -> URL {
        ...
        return appSupport
            .appendingPathComponent("Termifier", isDirectory: true)
