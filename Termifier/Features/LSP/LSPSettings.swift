...
//          true                  false         .silent
//
//  Both knobs default to `true` on first launch: Termifier attempts auto-install
...
struct LSPSettings: Sendable {
    ...
    static let autoInstallEnabledKey = "termifier.lsp.autoInstallEnabled"
    static let requireInstallConfirmationKey = "termifier.lsp.requireInstallConfirmation"
