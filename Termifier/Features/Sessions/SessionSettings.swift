...
// `Termifier/Helpers/SettingsStore.swift`'s header comment for the full
...
struct SessionSettings: Sendable {
    ...
    static let persistentSessionsEnabledKey = "termifier.session.persistentSessionsEnabled"
    static let agentResumeEnabledKey = "termifier.session.agentResumeEnabled"
    static let agentResumeAutoExecuteKey = "termifier.session.agentResumeAutoExecute"
    static let historyPersistenceEnabledKey = "termifier.session.historyPersistenceEnabled"
