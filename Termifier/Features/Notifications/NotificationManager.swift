...
private let logger = Logger(subsystem: "com.termifier.terminal", category: "NotificationManager")
...
class NotificationManager {
    ...
    private func requestPermission() {
        // The TermifierTests process is an XCTest host, not a real running
