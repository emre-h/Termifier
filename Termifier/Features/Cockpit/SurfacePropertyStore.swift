...
// .ghosttySetTitle/.ghosttySetPwd notifications TermifierWindowController
...
// via .termifierSurfaceDestroyed (SurfaceRegistry.destroySurface's own
...
// for this codebase.
//
// Surface-id resolution: unlike TermifierWindowController's own handlers
...
// TermifierTests/Cockpit/SurfacePropertyStoreTests.swift for the specced
// contract.
//
...
// TermifierWindowController's own handleSetTitleNotification).
