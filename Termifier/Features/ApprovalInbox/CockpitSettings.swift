...
struct CockpitSettings: Sendable {
    ...
    static let autoApproveEnabledKey = "termifier.cockpit.autoApproveEnabled"
    ...
    static let agentHookApprovalEnabledKey = "termifier.cockpit.agentHookApprovalEnabled"

    /// Gates whether `TermifierMCPServer`'s `POST /approval-request` endpoint
