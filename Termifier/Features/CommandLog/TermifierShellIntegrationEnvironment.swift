// TermifierShellIntegrationEnvironment.swift
// Termifier
//
...
enum TermifierShellIntegrationEnvironment {
    static let zdotdirVariableName = "ZDOTDIR"
    static let originalZdotdirVariableName = "TERMIFIER_ZSH_ZDOTDIR"
    ...
    /// PRE-EXISTING ZDOTDIR is preserved into TERMIFIER_ZSH_ZDOTDIR first --
    ...
    /// TERMIFIER_ZSH_ZDOTDIR (or unsets it if none was saved) and removes
    ...
    /// two. TERMIFIER_ZSH_ZDOTDIR itself is always cleared, regardless of
