...
// Termifier
//
// Shared install-then-apply sequencing for Termifier's own shell
// integration, used by both AppDelegate.applyTermifierShellIntegrationIfEnabled()
...
private let logger = Logger(subsystem: "com.termifier.terminal", category: "ShellIntegrationActivation")

enum ShellIntegrationActivation {

    /// Installs Termifier's own zsh/fish integration scripts into `root`,
