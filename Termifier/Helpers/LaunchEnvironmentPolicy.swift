...
// Termifier
//
// Decides whether this process is the TermifierTests unit-test host, so
// AppDelegate can gate its production launch body off of the developer's
// real ~/.termifier environment. Sibling to TestEnvironment.swift and reuses
...
// (TermifierUITests launches it with "--uitesting" instead), so that process
