...
// product-demo XCUITest scenario (TermifierUITests/DemoRecordingScenario.swift),
...
// TermifierWindowController's own 800x600-then-center() default would produce.
//
...
// the caller" split -- so TermifierTests can cover every malformed shape
