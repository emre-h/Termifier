...
//  (architecture.md §3's documented gap): Termifier never sets
...
//  launch. Termifier bundles its OWN version-matched copy of those scripts at
...
//
//  Proposed API (Termifier/GhosttyBridge/GhosttyResourcesDirResolver.swift),
...
//  directory; resourcesRoot/ghostty/shell-integration/... is Termifier's own
