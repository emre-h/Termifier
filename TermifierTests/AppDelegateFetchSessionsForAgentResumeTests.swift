...
//  than a live `termifier-session` subprocess, matching this codebase's
...
final class AppDelegateFetchSessionsForAgentResumeTests: XCTestCase {
    ...
    private let settingsSuiteName = "com.termifier.tests.AppDelegateFetchSessionsForAgentResumeTests"
