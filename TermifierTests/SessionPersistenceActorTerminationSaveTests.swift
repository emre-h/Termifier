...
//  the SAME actor method TermifierWindowController.windowWillClose's
...
//  instance pointed at a temp dir (TERMIFIER_UITEST_SESSION_DIR, this
...
//  non-empty `windowControllers` array of genuine TermifierWindowControllers,
...
final class SessionPersistenceActorTerminationSaveTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        setenv("TERMIFIER_UITEST_SESSION_DIR", tempDir.path, 1)
    }
