...
//  startObserving() idempotently subscribes to .termifierSurfaceDestroyed
...
//    mapping
//  - a .termifierSurfaceDestroyed notification for a registered surface
...
//  - the .termifierSurfaceDestroyed self-prune path notifies the observer
...
final class HerdrPaneRegistryTests: XCTestCase {
    ...
    // MARK: - .termifierSurfaceDestroyed pruning
    ...
    func test_surfaceDestroyedNotification_prunesOnlyThatSurface_leavesUnrelatedSurfaceIntact() {
        ...
        NotificationCenter.default.post(name: .termifierSurfaceDestroyed, object: nil, userInfo: ["surfaceID": destroyedSurface])
    ...
    // MARK: - Bridge observer: .termifierSurfaceDestroyed self-prune
    ...
    func test_surfaceDestroyedNotification_firesBridgeObserver_withPrunedRef() {
        ...
        NotificationCenter.default.post(name: .termifierSurfaceDestroyed, object: nil, userInfo: ["surfaceID": surfaceID])

        XCTAssertEqual(
            observer.receivedRefs, [ref],
            "the .termifierSurfaceDestroyed self-prune path routes through unregister and must fire the bridge " +
