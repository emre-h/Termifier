...
final class SessionPersistenceTests: XCTestCase {
    ...
    /// The save path should be ~/.termifier/sessions.json (not Application Support).
    ...
    func test_persistence_actor_save_path() async {
        ...
        let expectedPath = homeDir.appendingPathComponent(".termifier/sessions.json").path

        XCTAssertEqual(savePath.path, expectedPath,
                       "Save path should be ~/.termifier/sessions.json")
    }
