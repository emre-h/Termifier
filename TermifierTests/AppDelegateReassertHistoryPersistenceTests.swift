...
//  TermifierTests
//
//  The defect this file pins: the attach-spawned termifier-session
...
//  pane, by the FIRST `termifier-session attach --create` ghostty actually
...
final class AppDelegateReassertHistoryPersistenceTests: XCTestCase {
    ...
    private let settingsSuiteName = "com.termifier.tests.AppDelegateReassertHistoryPersistenceTests"
