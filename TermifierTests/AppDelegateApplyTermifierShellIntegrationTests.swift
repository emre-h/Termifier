//
//  AppDelegateApplyTermifierShellIntegrationTests.swift
//  TermifierTests
//
...
//  applyTermifierShellIntegrationIfEnabled() directly on a bare AppDelegate(),
...
//  applyTermifierShellIntegrationIfEnabled() does nothing -- so the enabled
...
@MainActor
final class AppDelegateApplyTermifierShellIntegrationTests: XCTestCase {

    private let settingsSuiteName = "com.termifier.tests.AppDelegateApplyTermifierShellIntegrationTests"
    ...
    private func makeTempDir() throws -> URL {
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("AppDelegateApplyTermifierShellIntegrationTests-\(UUID().uuidString)")
    ...
    func test_trackingEnabled_installsAndAppliesEnv_trackingDisabled_leavesBothUntouched() throws {
        ...
        appDelegate.applyTermifierShellIntegrationIfEnabled()
        ...
        secondAppDelegate.applyTermifierShellIntegrationIfEnabled()
