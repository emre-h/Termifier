...
//          languageId: String,
//          client: LSPClient,
//          clientCapabilities: ClientCapabilities = .termifierDefault(),
//          clientInfo: ClientInfo = .init(name: "Termifier", version: "0.26.1"),
...
final class LSPSessionPersistenceWiringTests: XCTestCase {
    ...
    private let workspaceA = URL(
        fileURLWithPath: "/tmp/termifier-lsp-persist-wire-A",
        isDirectory: true
    )
    private let workspaceB = URL(
        fileURLWithPath: "/tmp/termifier-lsp-persist-wire-B",
        isDirectory: true
    )
    ...
    func test_didOpen_persistsSnapshot() async throws {
        ...
        let uri = "file:///tmp/termifier-lsp-persist-wire-A/a.swift"
    ...
    func test_didOpenMultipleFiles_persistsAllInSnapshot() async throws {
        ...
        let uris = [
            "file:///tmp/termifier-lsp-persist-wire-A/a.swift",
            "file:///tmp/termifier-lsp-persist-wire-A/b.swift",
            "file:///tmp/termifier-lsp-persist-wire-A/c.swift",
        ]
    ...
    func test_lspService_availableSnapshots_returnsLoaded() async throws {
        ...
        let seeded = LSPSessionPersistence.SessionSnapshot(
            workspaceRoot: ws,
            languageId: lang,
            openFiles: ["file:///tmp/termifier-lsp-persist-wire-A/a.ts"],
    ...
    func test_lspService_newSession_propagatesPersistenceToSession() async throws {
        ...
        let uri = "file:///tmp/termifier-lsp-persist-wire-A/a.ts"
        try await session.didOpen(uri: uri, languageId: lang, version: 1, text: "// a")
    ...
    func test_lspService_concurrent_sessions_distinctPersistedSnapshots() async throws {
        ...
        let uriA = "file:///tmp/termifier-lsp-persist-wire-A/a.ts"
        let uriB = "file:///tmp/termifier-lsp-persist-wire-B/b.ts"
