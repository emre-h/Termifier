...
final class MCPLSPBridgeHierarchyToolsTests: XCTestCase {
    ...
    private let workspaceA = URL(fileURLWithPath: "/tmp/termifier-mcp-lsp-bridge-hier-A")
    private let fileA = "file:///tmp/termifier-mcp-lsp-bridge-hier-A/main.ts"
    ...
    func test_lspMoniker_returnsArrayOfMonikers() async throws {
        ...
        let monikersJSON = """
        [
          {"scheme":"tsc","identifier":"termifier::foo","unique":"document"},
          {"scheme":"npm","identifier":"@termifier/util::bar","unique":"global","kind":"export"}
        ]
        """
        ...
        XCTAssertEqual(arr[0]["identifier"] as? String, "termifier::foo")
    ...
    func test_lspMoniker_validResponse_includesUniquenessAndKind() async throws {
        ...
        let monikersJSON = """
        [
          {"scheme":"termifier","identifier":"termifier::Bar","unique":"global","kind":"import"}
        ]
        """
        await driver.setReply(method: "textDocument/moniker", jsonResult: monikersJSON)
        ...
        XCTAssertTrue(
            content.text.contains("\"identifier\":\"termifier::Bar\""),
