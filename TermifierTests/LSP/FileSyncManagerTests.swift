...
//      that path (e.g. Termifier-side writes echo back through FSEvents).
...
//  live under
//  `Termifier/Features/LSP/FileSyncManager.swift`.
//
...
final class FileSyncManagerTests: XCTestCase {
    ...
    private func makeWorkspaceRoot(_ name: String = "ws") -> URL {
        let base = URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("termifier-fs-sync-\(UUID().uuidString)")
