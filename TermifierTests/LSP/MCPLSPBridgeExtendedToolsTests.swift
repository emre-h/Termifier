...
//    drive Termifier-side state via LSPService and LSPInstaller)
...
final class MCPLSPBridgeExtendedToolsTests: XCTestCase {
    ...
    private let workspaceA = URL(fileURLWithPath: "/tmp/termifier-mcp-lsp-bridge-ext-A")
    private let workspaceB = URL(fileURLWithPath: "/tmp/termifier-mcp-lsp-bridge-ext-B")
    private let fileA = "file:///tmp/termifier-mcp-lsp-bridge-ext-A/main.ts"
    private let fileB = "file:///tmp/termifier-mcp-lsp-bridge-ext-B/main.ts"
