...
//  the live production source (Termifier/Features/LSP/LSPInstaller.swift) and
//  the registry table (Termifier/Features/LSP/LSPServerRegistry.swift).
//
...
//  actor exposed through `@testable import Termifier`.
//
