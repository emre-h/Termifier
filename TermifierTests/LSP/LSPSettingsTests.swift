...
//  `Termifier/Features/LSP/LSPSettings.swift`. The `ConfirmationMode` enum is
//  defined in `Termifier/Features/LSP/LSPInstaller.swift` and reused there;
...
final class LSPSettingsTests: XCTestCase {
    ...
    /// Termifier's product decision: when a language server is missing we
