...
//  JSON file under `~/Library/Application Support/Termifier/lsp/sessions.json`.
//
...
//      `~/Library/Application Support/Termifier/lsp/sessions.json`.
...
//  `Termifier/Features/LSP/LSPSessionPersistence.swift`:
...
//      persistence under `Termifier/Features/Persistence/SessionSnapshot.swift`).
//
...
final class LSPSessionPersistenceTests: XCTestCase {
    ...
    // ====================================================================
    // MARK: - 8. default storageURL lives under Application Support/Termifier/lsp
    // ====================================================================

    /// Contract: when constructed with no argument, the actor's `storageURL`
    /// resolves under `Library/Application Support/Termifier/lsp/sessions.json`.
    ...
    func test_storageURL_defaultsToApplicationSupport() {
        ...
        XCTAssertTrue(
            path.contains("Library/Application Support/Termifier/lsp/sessions.json"),
            "default storage URL must live under Library/Application Support/Termifier/lsp/sessions.json (got: \(path))"
        )
    }
