...
final class MCPLSPBridgeNotebookToolsTests: XCTestCase {
    ...
    private let workspaceA = URL(fileURLWithPath: "/tmp/termifier-mcp-lsp-bridge-notebook-A")
    private let fileA = "file:///tmp/termifier-mcp-lsp-bridge-notebook-A/main.ts"
    private let notebookUri = "file:///tmp/termifier-mcp-lsp-bridge-notebook-A/example.ipynb"
    private let cellOneUri = "file:///tmp/termifier-mcp-lsp-bridge-notebook-A/cell-1.py"
    private let cellTwoUri = "file:///tmp/termifier-mcp-lsp-bridge-notebook-A/cell-2.py"
