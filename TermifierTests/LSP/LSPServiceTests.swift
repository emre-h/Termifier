...
//  Termifier
//
//  Tests for `LSPService`, the @MainActor facade that the Termifier MCP layer
...
//  `Termifier/Features/LSP/LSPService.swift`.
//
...
final class LSPServiceTests: XCTestCase {
    ...
    private let workspaceA = URL(fileURLWithPath: "/tmp/termifier-lsp-service-test-A")
    private let workspaceB = URL(fileURLWithPath: "/tmp/termifier-lsp-service-test-B")
    private let workspaceC = URL(fileURLWithPath: "/tmp/termifier-lsp-service-test-C")
