...
//  live under `Termifier/Features/LSP/`.
//
...
final class LSPSessionTests: XCTestCase {
    ...
    private let testWorkspaceRoot = URL(fileURLWithPath: "/tmp/termifier-lsp-session-test")
    ...
    func test_didOpen_sendsParams() async throws {
        ...
        let uri = "file:///tmp/termifier-lsp-session-test/main.swift"
    ...
    func test_didChange_unopenedDocument_throws() async throws {
        ...
        let uri = "file:///tmp/termifier-lsp-session-test/missing.swift"
        do {
    ...
    func test_concurrentDidOpen_dedup() async throws {
        ...
        let uri = "file:///tmp/termifier-lsp-session-test/race.swift"
    ...
    func test_persistChain_doesNotGrowUnboundedlyAcrossRapidCycles() async throws {
        ...
        for i in 0..<burstSize {
            let uri = "file:///tmp/termifier-lsp-session-test/burst-\(i).swift"
