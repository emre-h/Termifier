...
final class LSPTypesHierarchyAndMonikerTests: XCTestCase {
    ...
    func test_moniker_minimal_roundtrip() throws {
        let json = #"""
        {"identifier":"termifier::foo","scheme":"termifier","unique":"document"}
        """#
    ...
    func test_moniker_withKind_import_roundtrip() throws {
        let json = #"""
        {"identifier":"termifier::Bar","kind":"import","scheme":"termifier","unique":"global"}
        """#
        try assertRoundtrip(Moniker.self, json: json)
    }
    ...
    func test_moniker_withKind_export_roundtrip() throws {
        let json = #"""
        {"identifier":"termifier::Baz","kind":"export","scheme":"termifier","unique":"project"}
        """#
        try assertRoundtrip(Moniker.self, json: json)
    }
    ...
    func test_moniker_directConstruction_minimal() {
        let m = Moniker(
            scheme: "termifier",
            identifier: "termifier::foo",
            unique: .document,
            kind: nil
        )
        XCTAssertEqual(m.scheme, "termifier")
        XCTAssertEqual(m.identifier, "termifier::foo")
    ...
    func test_moniker_equatable() {
        let a = Moniker(scheme: "termifier", identifier: "x", unique: .global, kind: .export)
        let b = Moniker(scheme: "termifier", identifier: "x", unique: .global, kind: .export)
        let c = Moniker(scheme: "termifier", identifier: "y", unique: .global, kind: .export)
        XCTAssertEqual(a, b)
