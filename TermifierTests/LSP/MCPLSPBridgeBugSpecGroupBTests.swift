...
final class MCPLSPBridgeBugSpecGroupBTests: XCTestCase {
    ...
    private let workspaceA = URL(fileURLWithPath: "/tmp/termifier-mcp-bridge-bug-grp-b-A")
    private let workspaceB = URL(fileURLWithPath: "/tmp/termifier-mcp-bridge-bug-grp-b-B")
    private let fileAUri = "file:///tmp/termifier-mcp-bridge-bug-grp-b-A/main.ts"
    private let fileBUri = "file:///tmp/termifier-mcp-bridge-bug-grp-b-B/main.ts"
    ...
    func test_hoverBundle_includesSurroundingCodeAroundPosition() async throws {
        ...
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("termifier-bridge-bug-grp-b-hover-\(UUID().uuidString)")
