...
//  `ClientInfo(name: "Termifier", version: "0.26.1")`. The version string is
...
final class LSPSessionClientInfoBugSpecTests: XCTestCase {
    ...
    private let testWorkspaceRoot = URL(fileURLWithPath: "/tmp/termifier-lsp-session-clientinfo-test")
