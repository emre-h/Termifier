...
//  Termifier
//
//  Tests for the eight "information cluster B" MCP tools the
...
//
//  The bridge must advertise 43 tools and route all of them: the
...
final class MCPLSPBridgeInfoClusterBTests: XCTestCase {
    ...
    private let workspaceA = URL(fileURLWithPath: "/tmp/termifier-mcp-lsp-bridge-info-B")
    private let fileA = "file:///tmp/termifier-mcp-lsp-bridge-info-B/main.ts"
