...
final class MCPLSPBridgeBugSpecGroupATests: XCTestCase {
    ...
    private let workspaceA = URL(fileURLWithPath: "/tmp/termifier-mcp-lsp-bridge-bugA")
    private let fileA = "file:///tmp/termifier-mcp-lsp-bridge-bugA/main.ts"
    ...
    func test_bug4_nonUTF8File_didOpenDispatchedOrEncodingError() async throws {
        ...
        let tmpDir = URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("termifier-bugA-\(UUID().uuidString)")
