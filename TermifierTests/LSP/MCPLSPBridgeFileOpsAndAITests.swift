...
final class MCPLSPBridgeFileOpsAndAITests: XCTestCase {
    ...
    private let workspaceA = URL(fileURLWithPath: "/tmp/termifier-mcp-lsp-bridge-fileops-ai-A")
    private let fileA = "file:///tmp/termifier-mcp-lsp-bridge-fileops-ai-A/main.ts"
    ...
    func test_lspWillCreateFiles_sendsCorrectLSPRequest() async throws {
        ...
        let args: [String: AnyCodable] = [
            ...
            "language_id": AnyCodable("typescript"),
            "files": filesUriArray([
                "file:///tmp/termifier-mcp-lsp-bridge-fileops-ai-A/new.ts",
            ]),
        ]
    ...
    func test_lspDidCreateFiles_sendsNotification() async throws {
        ...
        let args: [String: AnyCodable] = [
            ...
            "language_id": AnyCodable("typescript"),
            "files": filesUriArray([
                "file:///tmp/termifier-mcp-lsp-bridge-fileops-ai-A/created.ts",
            ]),
        ]
        let content = try await bridge.handleToolCall(
    ...
    func test_lspWillRenameFiles_sendsCorrectLSPRequest() async throws {
        ...
        let args: [String: AnyCodable] = [
            ...
            "files": filesRenameArray([
                (
                    "file:///tmp/termifier-mcp-lsp-bridge-fileops-ai-A/old.ts",
                    "file:///tmp/termifier-mcp-lsp-bridge-fileops-ai-A/new.ts"
                ),
            ]),
        ]
    ...
    func test_lspWillDeleteFiles_sendsCorrectLSPRequest() async throws {
        ...
        let args: [String: AnyCodable] = [
            ...
            "language_id": AnyCodable("typescript"),
            "files": filesUriArray([
                "file:///tmp/termifier-mcp-lsp-bridge-fileops-ai-A/gone.ts",
            ]),
        ]
        let content = try await bridge.handleToolCall(
    ...
    func test_lspDidDeleteFiles_sendsNotification() async throws {
        ...
        let args: [String: AnyCodable] = [
            ...
            "language_id": AnyCodable("typescript"),
            "files": filesUriArray([
                "file:///tmp/termifier-mcp-lsp-bridge-fileops-ai-A/deleted.ts",
            ]),
        ]
        let content = try await bridge.handleToolCall(
