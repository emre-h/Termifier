...
//
//  The types under test live under `Termifier/Features/LSP/LSPTypes/`.
//
...
final class LSPTypesLifecycleTests: XCTestCase {
    ...
    func test_workspaceFolder_roundtrip() throws {
        ...
        let json = #"{"name":"termifier","uri":"file:///Users/example/termifier"}"#
        try assertRoundtrip(WorkspaceFolder.self, json: json)

        // Direct construction sanity check (ensures memberwise initializer exists).
        let wf = WorkspaceFolder(uri: "file:///Users/example/termifier", name: "termifier")
        XCTAssertEqual(wf.uri, "file:///Users/example/termifier")
        XCTAssertEqual(wf.name, "termifier")
    }
    ...
    func test_clientInfo_withVersion_roundtrip() throws {
        let json = #"{"name":"Termifier","version":"0.26.1"}"#
    ...
    func test_initializeParams_clientInfoAndTrace_roundtrip() throws {
        ...
        {
          "capabilities":{},
          "clientInfo":{"name":"Termifier","version":"0.26.1"},
          "processId":12345,
          "trace":"verbose"
        }
        """#
    ...
    func test_initializeParams_fullPayload_roundtrip() throws {
        ...
        {
          "capabilities":{
            "experimental":{"termifier":{"version":1}},
    ...
    func test_serverCapabilities_executeCommandProvider_roundtrip() throws {
        let json = #"""
        {"executeCommandProvider":{"commands":["termifier.run","termifier.format"]}}
        """#
        try assertRoundtrip(ServerCapabilities.self, json: json)
    }
    ...
    func test_serverCapabilities_experimentalField_roundtrip() throws {
        let json = #"{"experimental":{"termifier":{"semverGated":true}}}"#
        try assertRoundtrip(ServerCapabilities.self, json: json)
    }
    ...
    func test_serverCapabilities_kitchenSink_roundtrip() throws {
        ...
        let json = #"""
        {
          ...
          "diagnosticProvider":{"identifier":"termifier","interFileDependencies":true,"workspaceDiagnostics":false},
          ...
          "executeCommandProvider":{"commands":["termifier.run"]},
          "experimental":{"termifier":{"version":1}},
