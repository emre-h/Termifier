...
//  15 languages Termifier ships with to their launch command, auto-install
//  command, prerequisite package managers, and detection rules.
//
//  The registry types under test live
//  under `Termifier/Features/LSP/LSPServerRegistry.swift`.
//
...
final class LSPServerRegistryTests: XCTestCase {
    ...
    // ====================================================================
    // MARK: - Codable round-trip (for ~/.config/termifier/lsp.json override)
    // ====================================================================
    ...
    /// Termifier into launching an attacker-controlled binary. All other
