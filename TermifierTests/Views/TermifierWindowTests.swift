//
//  TermifierWindowTests.swift
//  TermifierTests
//
//  Tests for the pure helper `TermifierWindow.shouldPerformZoom(pointInWindow:windowSize:titleBarHeight:trafficLightFrames:)`
...
//
//  These tests target the static helper `TermifierWindow.shouldPerformZoom`.
//
...
final class TermifierWindowTests: XCTestCase {
    ...
    func test_shouldPerformZoom_true_in_title_bar_away_from_traffic_lights() {
        ...
        let result = TermifierWindow.shouldPerformZoom(
            pointInWindow: point,
