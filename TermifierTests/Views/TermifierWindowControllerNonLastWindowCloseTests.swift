//
//  TermifierWindowControllerNonLastWindowCloseTests.swift
//  TermifierTests
//
...
//  (mirrors `TermifierWindowControllerFullScreenTests`'s established
...
//  safety (mirrors `TermifierWindowControllerCloseArmsTests`'s
...
@MainActor
final class TermifierWindowControllerNonLastWindowCloseTests: XCTestCase {
