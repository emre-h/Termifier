//
//  TermifierWindowControllerSnapshotCompletenessTests.swift
//  TermifierTests
//
//  Production saves (requestSave/saveImmediately/
//  applicationWillTerminate) all go through
//  TermifierWindowController.windowSnapshot(), which constructs its
...
//  real TermifierWindowController whose Tab
...
@MainActor
final class TermifierWindowControllerSnapshotCompletenessTests: XCTestCase {
    ...
    func test_windowSnapshot_preservesEveryTabGroupAndWindowField() throws {
        ...
        let controller = TermifierWindowController(window: window, windowSession: windowSession, restoring: true)

        // Representative non-default value for the isFullScreen/frame pair
        // (TermifierWindowControllerFullScreenTests already covers this pair's
