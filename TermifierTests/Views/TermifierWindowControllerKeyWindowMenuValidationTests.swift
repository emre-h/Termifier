//
//  TermifierWindowControllerKeyWindowMenuValidationTests.swift
//  TermifierTests
//
//  GitHub issue #45. Full root-cause writeup:
//  `NSWindow+TermifierClose.swift`'s header comment.
//
//  `TermifierWindowController.validateMenuItem(_:)` (TermifierWindowController
...
//  `TermifierWindowControllerCloseWindowTests`'s own precondition assertion
//  that a freshly constructed, never-shown `TermifierWindow` is never key).
//
...
//  `TermifierWindowController.swift`), so this file was extended to cover
...
//  itself) — see `TermifierWindowController.swift`'s own "Known gap"
...
@MainActor
final class TermifierWindowControllerKeyWindowMenuValidationTests: XCTestCase {

    // MARK: - Fixture

    private func makeFixture(session: WindowSession) -> TermifierWindowController {
    ...
    private func makeFixture(tabCount: Int) -> TermifierWindowController {
    ...
    private func makeFixture(groupCount: Int) -> TermifierWindowController {
    ...
    /// both together — see `TermifierWindowController`'s notification-arrival
    /// handling); `validateMenuItem` itself only ever reads
    /// `unreadNotifications`.
    private func makeFixtureWithUnreadTab() -> TermifierWindowController {
    ...
    func test_validateMenuItem_closeTab_disabledWhenNotKeyWindow() {
        ...
        let result = controller.validateMenuItem(menuItem(action: #selector(TermifierWindowController.closeTab(_:))))
    ...
    func test_validateMenuItem_closeGroup_disabledWhenNotKeyWindow() {
        ...
        let result = controller.validateMenuItem(menuItem(action: #selector(TermifierWindowController.closeGroup(_:))))
    ...
    func test_validateMenuItem_toggleFullScreen_disabledWhenNotKeyWindow() {
        ...
        let result = controller.validateMenuItem(menuItem(action: #selector(TermifierWindowController.toggleFullScreen(_:))))
    ...
    func test_validateMenuItem_selectNextTab_disabledWhenNotKeyWindow_evenWithMultipleTabs() {
        ...
        let result = controller.validateMenuItem(menuItem(action: #selector(TermifierWindowController.selectNextTab(_:))))
    ...
    func test_validateMenuItem_selectPreviousTab_disabledWhenNotKeyWindow_evenWithMultipleTabs() {
        ...
        let result = controller.validateMenuItem(menuItem(action: #selector(TermifierWindowController.selectPreviousTab(_:))))
    ...
    func test_validateMenuItem_nextGroup_disabledWhenNotKeyWindow_evenWithMultipleGroups() {
        ...
        let result = controller.validateMenuItem(menuItem(action: #selector(TermifierWindowController.nextGroup(_:))))
    ...
    func test_validateMenuItem_previousGroup_disabledWhenNotKeyWindow_evenWithMultipleGroups() {
        ...
        let result = controller.validateMenuItem(menuItem(action: #selector(TermifierWindowController.previousGroup(_:))))
    ...
    func test_validateMenuItem_jumpToMostRecentUnreadTab_disabledWhenNotKeyWindow_evenWithUnreadTab() {
        ...
        let result = controller.validateMenuItem(menuItem(action: #selector(TermifierWindowController.jumpToMostRecentUnreadTab)))
    ...
    func test_validateMenuItem_toggleSidebar_disabledWhenNotKeyWindow() {
        ...
        let result = controller.validateMenuItem(menuItem(action: #selector(TermifierWindowController.toggleSidebar)))
    ...
    func test_validateMenuItem_toggleCommandPalette_disabledWhenNotKeyWindow() {
        ...
        let result = controller.validateMenuItem(menuItem(action: #selector(TermifierWindowController.toggleCommandPalette)))
    ...
    func test_validateMenuItem_toggleComposeOverlay_disabledWhenNotKeyWindow() {
        ...
        let result = controller.validateMenuItem(menuItem(action: #selector(TermifierWindowController.toggleComposeOverlay)))
    ...
    func test_validateMenuItem_findNext_disabledWhenNotKeyWindow() {
        ...
        let result = controller.validateMenuItem(menuItem(action: #selector(TermifierWindowController.findNext(_:))))
    ...
    func test_validateMenuItem_findPrevious_disabledWhenNotKeyWindow() {
        ...
        let result = controller.validateMenuItem(menuItem(action: #selector(TermifierWindowController.findPrevious(_:))))
    ...
    func test_validateMenuItem_newTab_enabledRegardlessOfKeyWindow() {
        let controller = makeFixture(tabCount: 1)
        let item = menuItem(action: #selector(TermifierWindowController.newTab(_:)))
    ...
    func test_validateMenuItem_newBrowserTab_enabledRegardlessOfKeyWindow() {
        let controller = makeFixture(tabCount: 1)
        let item = menuItem(action: #selector(TermifierWindowController.newBrowserTab(_:)))
    ...
    func test_validateMenuItem_newGroup_enabledRegardlessOfKeyWindow() {
        let controller = makeFixture(tabCount: 1)
        let item = menuItem(action: #selector(TermifierWindowController.newGroup(_:)))
