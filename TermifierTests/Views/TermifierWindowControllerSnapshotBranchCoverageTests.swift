//
//  TermifierWindowControllerSnapshotBranchCoverageTests.swift
//  TermifierTests
//
...
//       `content` URL) -- TermifierWindowControllerSnapshotCompletenessTests
...
//  DEBUG seam (TermifierWindowController.swift) to inject a live
...
@MainActor
final class TermifierWindowControllerSnapshotBranchCoverageTests: XCTestCase {

    private func makeController(tab: Tab) -> TermifierWindowController {
        ...
        return TermifierWindowController(window: window, windowSession: windowSession, restoring: true)
    }
