//
//  TermifierWindowControllerFullScreenTests.swift
//  TermifierTests
//
...
@MainActor
final class TermifierWindowControllerFullScreenTests: XCTestCase {

    // MARK: - Helpers

    /// Build a minimal `TermifierWindowController` for direct delegate invocation.
    ...
    //
    // CONSTRAINT: `isRestoring` is declared `private` on `TermifierWindowController`,
