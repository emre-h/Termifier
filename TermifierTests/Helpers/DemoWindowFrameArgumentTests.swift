...
//  TermifierTests
//
//  Coverage for DemoWindowFrameArgument.parse(_:) (Termifier/Helpers
...
//  (TermifierUITests/DemoRecordingScenario.swift). Deliberately does not
...
final class DemoWindowFrameArgumentTests: XCTestCase {
    ...
    func test_matchAmongOtherArguments_stillParses() {
        let size = DemoWindowFrameArgument.parse([
            "/path/to/Termifier", "--uitesting", "-AppleLanguages", "(en)", "--demo-window-frame=1920x1080"
        ])
