...
//  `@Observable` view-model, one instance owned per TermifierWindowController,
...
//  keep IT independent of TermifierWindowController.
//
...
//
//  Proposed API (new file, Termifier/Features/Persistence/RecoveryBarModel.swift,
//  alongside SessionPersistenceActor.swift/SessionSnapshot.swift -- this
//  is a persistence-recovery concern, not a Sessions/termifier-session-daemon
...
//    }
//
//  Wiring this needs at the AppDelegate/TermifierWindowController level
...
//    must hand its new TermifierWindowController a RecoveryBarModel seeded
