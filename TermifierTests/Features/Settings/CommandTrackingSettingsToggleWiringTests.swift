...
final class CommandTrackingSettingsToggleWiringTests: XCTestCase {
    ...
    // DEBUG-only seam AppDelegateApplyTermifierShellIntegrationTests uses for
    ...
    private let settingsSuiteName = "com.termifier.tests.CommandTrackingSettingsToggleWiringTests"

    private var originalZdotdir: String?
    private var originalXdgDataDirs: String?
    private var originalTermifierZshZdotdir: String?
    ...
    override func setUp() {
        ...
        originalTermifierZshZdotdir = ProcessInfo.processInfo.environment["TERMIFIER_ZSH_ZDOTDIR"]
    }
    ...
    override func tearDown() {
        ...
        for (name, value) in [
            ...
            ("TERMIFIER_ZSH_ZDOTDIR", originalTermifierZshZdotdir),
        ] {
            if let value {
                setenv(name, value, 1)
            } else {
