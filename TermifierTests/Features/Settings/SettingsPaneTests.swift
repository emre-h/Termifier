...
//  adjust-cursor-thickness, cursor-style, shell-integration-features,
//  font-codepoint-map, and foreground -- all
//  appearance keys,
...
//  TermifierMCPServer's POST /approval-request endpoint (see that setting's
