...
//  TermifierMCPServer's POST /approval-request endpoint (a CLI agent's
...
//    -- same "termifier.settings.sessions.*" prefix as cockpitAutoApproveSwitch,
...
final class AgentHookApprovalSettingsToggleWiringTests: XCTestCase {
    ...
    private let settingsSuiteName = "com.termifier.tests.AgentHookApprovalSettingsToggleWiringTests"
