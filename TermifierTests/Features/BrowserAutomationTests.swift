...
final class BrowserAutomationTests: XCTestCase {
    ...
    func test_snapshot_stamps_data_termifier_ref() {
        let js = BrowserAutomation.snapshot()
        XCTAssertTrue(js.contains("data-termifier-ref"),
                      "snapshot JS should stamp data-termifier-ref attributes")
    }
    ...
    func test_click_with_ref_selector() {
        ...
        XCTAssertTrue(js.contains("data-termifier-ref"),
                      "click with @ref should resolve to data-termifier-ref selector")
    ...
    func test_clearRefs_removes_data_termifier_ref() {
        let js = BrowserAutomation.clearRefs()
        XCTAssertTrue(js.contains("data-termifier-ref"),
                      "clearRefs JS should reference data-termifier-ref attributes")
    }
