...
//    that surface's cwd
//  - a .termifierSurfaceDestroyed notification prunes that surface's
//    recorded title
...
final class SurfacePropertyStoreTests: XCTestCase {
    ...
    func test_surfaceDestroyed_prunesEntry() {
        ...
        NotificationCenter.default.post(name: .termifierSurfaceDestroyed, object: nil, userInfo: ["surfaceID": id])
    ...
    /// destroy path -- both must post `.termifierSurfaceDestroyed` so
