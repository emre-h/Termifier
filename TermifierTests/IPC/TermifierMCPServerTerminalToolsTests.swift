//
//  TermifierMCPServerTerminalToolsTests.swift
//  TermifierTests
//
//  Covers the terminal_* MCP tool surface wired into
//  TermifierMCPServer: tools/list advertises the 3 terminal_* tools, and
//  tools/call dispatches them through MCPCommandLogBridge via the
//  injected commandLogStore -- mirroring TermifierMCPServerLSPIntegrationTests'
...
@MainActor
final class TermifierMCPServerTerminalToolsTests: XCTestCase {
    ...
    // MARK: - Helpers (mirroring TermifierMCPServerLSPIntegrationTests)
