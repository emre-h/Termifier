//
//  TermifierMCPServerCockpitToolsTests.swift
//  TermifierTests
//
//  Covers the Cockpit MCP tool surface wired into TermifierMCPServer:
...
//  mirroring TermifierMCPServerTerminalToolsTests' structure at a small
...
//    not in inboxSyncToolNames), unlike a termifier-ipc messaging tool call,
//    mirroring TermifierMCPServerAgentEventTests' own lsp_hover exclusion test
...
@MainActor
final class TermifierMCPServerCockpitToolsTests: XCTestCase {
    ...
    // MARK: - Helpers (mirroring TermifierMCPServerTerminalToolsTests)
    ...
    func test_toolsCall_paneList_dispatchesToBridge_returnsPanesJSON() async throws {
        ...
        let pane = CockpitPaneInfo(
            ...
            tabTitle: "zsh", title: nil, cwd: nil, isFocused: true, agentKind: nil, termifierSessionID: nil
        )
        access.panes = [pane]
    ...
    /// Mirrors `TermifierMCPServerAgentEventTests
    ...
    /// NOT refresh it (unlike a termifier-ipc messaging tool call, which
    ...
    // MARK: - Peer-binding helpers (mirrors TermifierMCPServerAgentEventTests)
