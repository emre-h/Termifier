...
//  `TermifierMCPServer.approvalInbox`/`agentRegistry`) -- every test below
...
final class ApprovalBannerModelTests: XCTestCase {
    ...
    /// `TermifierMCPServer` builds an `.agentHook` `ApprovalRequest` from a
    ...
    func test_alwaysAllow_enablesAutoApproveSetting_andAllows() async throws {
        let suiteName = "com.termifier.tests.ApprovalBannerModelTests.alwaysAllow"
    ...
    func test_alwaysAllow_drainsAllVisiblePendingRequests() async throws {
        let suiteName = "com.termifier.tests.ApprovalBannerModelTests.alwaysAllowDrain"
        CockpitSettings._testUseSuite(named: suiteName)
        defer { CockpitSettings._testTeardownSuite(named: suiteName) }
    ...
    func test_alwaysAllow_mcpTool_drainsEveryOtherMcpToolRequest_regardlessOfSurface() async throws {
        let suiteName = "com.termifier.tests.ApprovalBannerModelTests.alwaysAllowDrainsAcrossSurfaces"
        CockpitSettings._testUseSuite(named: suiteName)
        defer { CockpitSettings._testTeardownSuite(named: suiteName) }
    ...
    func test_alwaysAllow_mcpToolSource_doesNotDrainQueuedAgentHookRequest_onSameSurface() async throws {
        let suiteName = "com.termifier.tests.ApprovalBannerModelTests.alwaysAllowMcpToolDoesNotDrainAgentHook"
        CockpitSettings._testUseSuite(named: suiteName)
        defer { CockpitSettings._testTeardownSuite(named: suiteName) }
        XCTAssertFalse(CockpitSettings.autoApproveEnabled, "precondition: the isolated suite starts with auto-approve off")
    ...
    func test_alwaysAllow_agentHookSource_recordsPaneMemory_neverTouchesGlobalAutoApprove() async throws {
        let suiteName = "com.termifier.tests.ApprovalBannerModelTests.alwaysAllowAgentHookPaneMemory"
        CockpitSettings._testUseSuite(named: suiteName)
        defer { CockpitSettings._testTeardownSuite(named: suiteName) }
        XCTAssertFalse(CockpitSettings.autoApproveEnabled, "precondition: the isolated suite starts with auto-approve off")
    ...
    func test_alwaysAllow_agentHookSource_drainsOnlySamePaneSameToolPending() async throws {
        let suiteName = "com.termifier.tests.ApprovalBannerModelTests.alwaysAllowAgentHookDrain"
        CockpitSettings._testUseSuite(named: suiteName)
        defer { CockpitSettings._testTeardownSuite(named: suiteName) }
    ...
    func test_alwaysAllow_agentHook_onDisplayedRequest_advancesToSuccessor() async throws {
        let suiteName = "com.termifier.tests.ApprovalBannerModelTests.navigationAlwaysAllowAgentHook"
        CockpitSettings._testUseSuite(named: suiteName)
        defer { CockpitSettings._testTeardownSuite(named: suiteName) }
    ...
    func test_alwaysAllow_agentHook_drainSweepsSuccessor_cursorLandsOnForwardSurvivor() async throws {
        let suiteName = "com.termifier.tests.ApprovalBannerModelTests.drainSweepsSuccessor"
        CockpitSettings._testUseSuite(named: suiteName)
        defer { CockpitSettings._testTeardownSuite(named: suiteName) }
    ...
    func test_alwaysAllow_agentHook_drainSweepsAllForward_cursorFallsBackToNearestPredecessor() async throws {
        let suiteName = "com.termifier.tests.ApprovalBannerModelTests.drainSweepsAllForward"
        CockpitSettings._testUseSuite(named: suiteName)
        defer { CockpitSettings._testTeardownSuite(named: suiteName) }
    ...
    // .termifierApprovalInboxChanged itself, since an NSMenuItem's action runs
    ...
    // "termifier.approvalBanner.*" prefix convention as
    ...
    func test_accessibilityID_approvalBanner_optionsMenuAndPayloadExpandedIdentifiers_existAndAreDistinct() {
        XCTAssertEqual(AccessibilityID.ApprovalBanner.optionsMenu, "termifier.approvalBanner.optionsMenu")
        XCTAssertEqual(AccessibilityID.ApprovalBanner.payloadExpanded, "termifier.approvalBanner.payloadExpanded")
        ...
        for identifier in newIdentifiers {
            XCTAssertTrue(identifier.hasPrefix("termifier.approvalBanner."),
                         "\(identifier) must follow the existing termifier.approvalBanner.* naming convention")
        }
    ...
    func test_accessibilityID_approvalBanner_queueMenuIdentifier_existsAndIsDistinct() {
        ...
        XCTAssertTrue(newIdentifier.hasPrefix("termifier.approvalBanner."),
                     "\(newIdentifier) must follow the existing termifier.approvalBanner.* naming convention")
    ...
    func test_accessibilityID_approvalBanner_dismissButtonIdentifier_existsAndIsDistinct() {
        XCTAssertEqual(AccessibilityID.ApprovalBanner.dismissButton, "termifier.approvalBanner.dismissButton")
    ...
    func test_accessibilityID_approvalBanner_questionIdentifiers_existAndAreDistinct() {
        ...
        XCTAssertEqual(AccessibilityID.ApprovalBanner.optionButton(0), "termifier.approvalBanner.optionButton.0")
        XCTAssertEqual(AccessibilityID.ApprovalBanner.optionButton(1), "termifier.approvalBanner.optionButton.1")
    ...
    // anything else), dismiss(id:) works for EVERY source -- "Termifier does
    ...
    /// isDismissible`, false for either kind: Termifier's gate is their only
    ...
    func test_alwaysAllow_agentHook_neverDrainsAgentQuestionRequest_withSameKindAndToolName() async throws {
        let suiteName = "com.termifier.tests.ApprovalBannerModelTests.alwaysAllowNeverDrainsQuestion"
        CockpitSettings._testUseSuite(named: suiteName)
        defer { CockpitSettings._testTeardownSuite(named: suiteName) }
