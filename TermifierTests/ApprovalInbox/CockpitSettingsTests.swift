...
final class CockpitSettingsTests: XCTestCase {
    ...
    private let suiteName = "com.termifier.tests.CockpitSettingsTests"
    ...
    // TermifierMCPServer's new POST /approval-request endpoint ever submits
    ...
    func test_agentHookApprovalEnabled_defaultFalse_andRoundTrips() {
        ...
        XCTAssertEqual(CockpitSettings.agentHookApprovalEnabledKey, "termifier.cockpit.agentHookApprovalEnabled",
