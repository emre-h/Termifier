...
//  queries the LOCAL termifier-session daemon's `ls --all --json` ledger
...
//  TermifierWindowController.processChildExited and every test in
...
//  `isRemote` from TermifierWindowController.processChildExited via
...
final class SessionReconnectCoordinatorRemoteAwareChildExitedTests: XCTestCase {
    ...
    private let settingsSuiteName = "com.termifier.tests.SessionReconnectCoordinatorRemoteAwareChildExitedTests"
