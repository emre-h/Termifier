...
//  `TermifierWindowController.performReconnect` calls
...
//  relies on `TermifierWindowController
...
//  immediate `.unreachable`, depending on whether a `termifier-session`
...
//  swap, which `TermifierWindowController._sessionReconnectCoordinatorForTesting`
...
final class SessionReconnectAttemptResetTimingTests: XCTestCase {
    ...
    func test_performReconnect_doesNotResetAttemptCountImmediately_uponSwappingInReplacementSurface() {
        ...
        // would bail out ("No termifier-session binary resolvable") before
