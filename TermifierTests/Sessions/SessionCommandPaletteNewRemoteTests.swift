...
//  `TermifierWindowController.setupCommandRegistry` alongside
...
//  concern), TermifierWindowController.remoteSessionSpawnContext(forHost:)
...
//
//  Under test: TermifierWindowController's
...
final class SessionCommandPaletteNewRemoteTests: XCTestCase {
    ...
    private let settingsSuiteName = "com.termifier.tests.SessionCommandPaletteNewRemoteTests"
