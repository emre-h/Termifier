//
//  TermifierWindowControllerRemoteKillRoutingTests.swift
//  TermifierTests
//
...
//  the LOCAL-only operation, silently orphaning the remote termifier-session
//  forever.
//
//  WHERE HOST LIVES AT KILL TIME: exactly like performReconnect's own
//  identical read (see TermifierWindowControllerRemoteReconnectCommandTests'
...
@MainActor
final class TermifierWindowControllerRemoteKillRoutingTests: XCTestCase {
    ...
    func test_sessionKill_remoteSessionRef_routesObserverWithGivenHost() throws {
        ...
        XCTAssertEqual(result.host, "devbox.example.com",
                       ...
                       "orphans the remote termifier-session today")
    }
