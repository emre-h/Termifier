...
//  (TermifierWindowController.handleReconnectGiveUp, see
...
/// `termifier-session` binary involved.
...
final class SessionReconnectCoordinatorTests: XCTestCase {
    ...
    private let settingsSuiteName = "com.termifier.tests.SessionReconnectCoordinatorTests"
    ...
    // caller (`TermifierWindowController.handleReconnectGiveUp`), which
