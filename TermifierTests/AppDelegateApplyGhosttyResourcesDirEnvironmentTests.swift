...
//  `termifier-session attach` as the surface command; the Rust attach client
...
//  environment already has it, and Termifier never sets it today
...
//  version-mismatched resources, not Termifier's own bundled, version-matched
...
//  codebase (GhosttyThemeProvider, GhosttyAction, TermifierWindowController,
