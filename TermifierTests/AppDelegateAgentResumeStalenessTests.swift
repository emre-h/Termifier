...
//  a live termifier-session process. Pumps the shared agentResumeSessionsTask
...
/// a process boundary stand-in, no real termifier-session binary involved.
...
final class AppDelegateAgentResumeStalenessTests: XCTestCase {
    ...
    private let settingsSuiteName = "com.termifier.tests.AppDelegateAgentResumeStalenessTests"
